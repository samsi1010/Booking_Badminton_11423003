            ...
            <x-dialog-modal wire:model="confirmingDealAdd">
                ...
                <x-slot name="content">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model="newDeal.discount" id="discount" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ringblue-500 focus:borderblue-500 sm:text-sm">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="checkbox" wire:model="newDeal.is_hidden" id="is_hidden" class="block w-5 h-5 mt-1 border-gray-300 rounded-md shadow-sm focus:ringblue-500 focus:borderblue-500 sm:text-sm">
