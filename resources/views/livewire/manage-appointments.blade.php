...
{{--                        <input type="text" wire:model="appointment.name" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ringblue--500 focus:border-blue-500 sm:text-sm">--}}
